...
namespace PortfolioFinal.Controllers
{
    public class CreditsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "CreditID,Name,CompanyName,UsedIn,URL")] Credit credit)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "CreditID,Name,CompanyName,UsedIn,URL")] Credit credit)
        {
            if (ModelState.IsValid)
            {
